...
if (  isset($_SESSION['make']) && isset($_SESSION['year']) && isset($_SESSION['mileage'])&&isset($_SESSION['model']) && strlen($_SESSION['model'])>0  ) {
...
echo ("<li><!--".$row['autos_id']."-->".htmlentities($row['year'])." ".htmlentities($row['make'])." / ".htmlentities($row['mileage'])."</li>" );
